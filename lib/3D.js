    ...
    readObj.scene &&
      readObj.scene.traverse(function (child) {
        if (child.isMesh) {
          ...
          //   roughness: 0,
          //   metalness: 1,
          //   color: currentObject.color || 0xf50000,
          // });
          // var second = child.clone();
          // second.material = new THREE.MeshPhysicalMaterial({
          //   envMap: hervisions_hdri,
          //   roughness: 0,
          //   metalness: 1,
          //   color: currentObject.color || 0xf50000,
          ...
          console.log(
            Object.keys(THREE).filter((map) => map.indexOf('Mapping') !== -1)
          );
