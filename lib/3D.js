...
function initGraphics() {
	...
	var hdri = textureLoader.load( './images/hdri.jpg' );
	hdri.mapping = THREE.SphericalReflectionMapping;

	var hervisions_hdri = textureLoader.load( './images/hervisions_env_2.jpg' );
	hervisions_hdri.mapping = THREE.SphericalReflectionMapping;

	var hervisions_hdri2 = textureLoader.load( './images/hervisions_env.jpg' );
	hervisions_hdri2.mapping = THREE.SphericalReflectionMapping;

	var revision_hdri = textureLoader.load( './images/revision_env.jpg' );
