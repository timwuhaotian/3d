...
function initGraphics() {
	...
	// var textBg = textureLoader.load( './images/background.png' );
	// textBg.mapping = THREE.mapping
	// scene.background = textBg;

	var hdri = textureLoader.load( './images/panny-yu.png' );
	hdri.mapping = THREE.SphericalReflectionMapping;

	var hervisions_hdri = textureLoader.load( './images/yunpei-li.png' );
	hervisions_hdri.mapping = THREE.SphericalReflectionMapping;

	var hervisions_hdri2 = textureLoader.load( './images/yushan-liu.png' );
	hervisions_hdri2.mapping = THREE.SphericalReflectionMapping;

	var revision_hdri = textureLoader.load( './images/h1.png' );
	...
	objLoader.load( './panny-obj/object-1-1.obj', function ( readObj ) {
		...
		readObj && readObj.traverse( function ( child ) {
			...
			if ( child instanceof THREE.Mesh ) {
				...
				second.material = new THREE.MeshPhysicalMaterial({envMap: hervisions_hdri, roughness: 0, metalness: 1, color: 0xffffff});
		...
		readObj.scale.set(0.3,0.3,0.3);
		readObj.rotation.z = 90;
		readObj.position.set(0,0,0);
		createObjects();
		setTimeout(function(){
	...
	// loader.load( './panny-obj/3D_Final.fbx', function ( object ) {
